...
> In case you're curious about how LLM inference engines like vLLM work, You can also checkout [my deep dive into nano-vLLM.](https://cefboud.com/posts/inside-llm-inference-engine-nano-vllm-explanation/)
