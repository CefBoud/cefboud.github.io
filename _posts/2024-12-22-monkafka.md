---
title: "MonKafka: Building a Kafka Broker from Scratch with Zero Dependencies (So Far)"
author: cef
date: 2024-12-22
...
<a href="https://github.com/CefBoud/monkafka" target="_blank">MonKafka</a> is a minimal, zero-dependency implementation of a basic Kafka broker.  In this post, I will walk through the first steps in creating a minimalistic Kafka broker

# Intro
A few weeks ago, I wrote a [blog post](https://cefboud.github.io/posts/exploring-kafka-internals/) about my modest exploration of the Kafka codebase. The code diving has been very fun, and I've learned a lot along the way—especially about networking and concurrency, with a Java flavor. 
...
And this is it for now - more to come later. Thanks for making it this far!
# TODO
# Tagged fields
